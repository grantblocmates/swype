  ...
  return (
    <div className="max-w-2xl mx-auto px-4">
      ...
      <div className="mt-6 text-center">
        ...
        >
          <ArrowCounterClockwise className="w-3.5 h-3.5 inline mr-1.5" weight="bold" />
          Retake quiz
        </Link>
      </div>
    </div>
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <h3 className="text-lg font-display text-foreground mt-1.5">
                {card.displayName}
              </h3>
          ...
          {/* Match reason */}
          <p className="text-sm text-accent-emerald font-medium mt-2">{matchReason}</p>
